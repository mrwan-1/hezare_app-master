...
import 'package:hezare_app/app/data/models/user_model.dart';
...
class RegisterController extends GetxController {
  ...
  onSubmit() async {
    ...
    //     );
    print(
        "$ownerName, ${imgData?.fileName}, $serviceName, $ownerPhoneNumber, $servicePhoneNumber, $bankAccountType, $bankAccountNumber, $region, $address");
